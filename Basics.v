...
Example test_bin_inc_0: incr Z = B Z.
Proof. reflexivity. Qed.

Example test_bin_inc_1: incr (B Z)  = A (B Z).
Proof. reflexivity. Qed.

Example test_bin_inc_2: incr (A (B Z)) = B (B Z).
Proof. reflexivity. Qed.
...
Example test_bin_to_nat_0: bin_to_nat Z = 0. Proof. reflexivity. Qed. 
Example test_bin_to_nat_1: bin_to_nat (B Z) = 1. Proof. reflexivity. Qed. 
Example test_bin_to_nat_2: bin_to_nat (A (B Z)) = 2. Proof. reflexivity. Qed. 
